...
const socialLinks = [
  {
    name: "Facebook",
    handle: "@HarmonicAcademy",
    href: "https://facebook.com/HarmonicAcademy",
  ...
  {
    name: "Instagram",
    handle: "@harmonic_music",
    href: "https://instagram.com/harmonic_music",
  ...
  },
  {
    name: "X (Twitter)",
    handle: "@HarmonicAcademy",
    href: "https://x.com/HarmonicAcademy",
  ...
  {
    name: "LinkedIn",
    handle: "Harmonic Learning Studio",
    href: "https://linkedin.com/company/harmonic-music",
        ...
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <p className="mt-3 text-muted dark:text-dark-text/60">
              Follow us on social media for daily inspiration, student performances, and behind-the-scenes content
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {socialLinks.map((social, i) => (
            <motion.a
              ...
              className={`group flex flex-col items-center gap-3 p-6 rounded-2xl bg-white dark:bg-dark-surface border border-border dark:border-dark-border hover:text-white transition-all duration-300 ${social.color}`}
            >
